...
function dateFormat(date, format) {
  ...
  var f = {
    ...
    //standart format for all date times 
    x: function () {
      return f.d() + '/' + f.m() + '/' + f.Y() + ' ' + f.h() + ':' + f.i() + f.A();//d/m/Y H:mA
    },
    //standart function for all dates
    e: function () {
      return f.d() + '/' + f.m() + '/' + f.Y();
    }
  };
...
export { filteredData, pagedData, dateFormat }
