...
import TimeScaleHook from 'waveform-playlist/lib/render/TimeScaleHook';
...
class TimeScale {
  ...
  */
  ...
  render() {
    const widthX = Math.min(window.screen.width, secondsToPixels(this.duration, this.samplesPerPixel, this.sampleRate));
