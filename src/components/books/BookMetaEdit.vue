              ...
              <table class='properties'>
                ...
                <tr class='author'>
                  ...
                  <td style="text-align: left !important;">
                    ...
                    <template v-for="(author, i) in currentBook.author" ><input :value='currentBook.author[i]' v-on:keyup="debounceUpdate('author.'+i, $event.target.value, $event);" :disabled="!allowMetadataEdit">
