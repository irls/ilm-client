  ...
  <modal name="bookEditCoverModal"
    ...
    <div class="modal-header">
      <div class="header-title">
        ...
        <h3 class="header-h">Book Cover</h3>
      </div>
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="col-sm-8">
                ...
                <p v-if="errorCoverFileType"><span class="alert alert-warning">Please select image file for cover</span>
                </p>
                <label class='btn btn-default' type="file">
                  <i class="fa fa-folder-open-o" aria-hidden="true"></i> &nbsp; Browse for bookcover file &hellip;
                  <input name="coverFile" type="file" v-show="false" accept="image/*"
