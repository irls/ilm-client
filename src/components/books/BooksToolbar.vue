...
<div class="toolbar">
  ...
  <button v-if='hasBookSelected()' :disabled="!allowMetadataEdit" class='btn btn-default btn-meta' @click='toggleMetaVisible'><i :class="[metaVisible ? 'fa-chevron-right': 'fa-chevron-left', 'fa fa-lg collapsebtn']" aria-hidden="true"></i>Meta</button>
