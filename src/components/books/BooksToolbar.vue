...
<div class="toolbar">
  ...
  <!-- Meta Filter -->
    <input v-model="bookFilters.filter" type="text" class="form-control" style="width: 15em;" placeholder="Filter by Author or Title" @keyup="filterChange()"></input>
    <i class="fa fa-times-circle-o btn-inside"  aria-hidden="true" @click="bookFilters.filter='';"></i>

    <input v-model="bookFilters.projectTag" type="text" class="form-control" style="width: 18em;" placeholder="Filter by Editor or Project tag" @keyup="filterChange()"></input>
